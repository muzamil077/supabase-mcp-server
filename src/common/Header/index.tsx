...
import { FiSun, FiSearch, FiUser, FiLogOut } from "react-icons/fi";
          ...
          {!loading && (
            user ? (
              <div className="relative">
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-accent-orange to-purple-500 flex items-center justify-center text-white text-sm font-bold">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Link
                  to="/register"
                  className="px-4 py-2 rounded-lg text-sm font-medium bg-accent-orange text-white hover:bg-accent-orange/90 transition-all"
                >
                  Sign Up
                </Link>
              </div>
